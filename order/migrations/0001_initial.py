...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0002_auto_20171206_1209'),
        ('books', '0002_auto_20171208_1153'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(1, '待支付'), (2, '待发货'), (3, '待收货'), (4, '待评论'), (5, '已完成')], default=1, verbose_name='订单状态')),
                ('trade_id', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='订单编号')),
